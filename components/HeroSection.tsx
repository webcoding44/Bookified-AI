        ...
        <div className='library-hero-content'>
          ...
          <div className='library-hero-text'>
            ...
            >
              ...
              <span className='text-[var(--text-primary)]'>Add new book</span>
            </Link>
          </div>
          ...
          <div className='library-steps-card min-w-[260px] max-w-[280px] z-10 shadow-soft-md'>
            <ul className='space-y-6'>
              <li className='library-step-item'>
                <div className='w-10 h-10 min-w-10 min-h-10 rounded-full border border-[var(--border-subtle)] bg-[var(--accent-light)] text-[var(--text-primary)] flex items-center justify-center font-medium text-lg'>
                  1
                </div>
                <div className='flex flex-col'>
                  ...
                  <p className='library-step-description text-[var(--text-secondary)]'>
                    Add your book file
                  </p>
                </div>
              </li>
